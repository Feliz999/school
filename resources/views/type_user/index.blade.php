...
<div class="container">
    <div class="row">
        <div class="col text-center shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <hr>
            <form action="{{route('typeUser.store')}}" method="post" class="form">
                @csrf
            ...
            @if(isset($tus))
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" data-bs-toggle="modal" data-bs-target="#editarTipo-{{$tu->id}}"><i data-fa-symbol="edit" class="fa-solid fa-pencil fa-fw"></i></a>
                            <a href="" data-bs-toggle="modal" data-bs-target="#eliminarTipo-{{$tu->id}}"><i data-fa-symbol="delete" class="fa-solid fa-trash fa-fw" style="color:red"></i></a>
                        </td>
                    </tr>
                        @include('type_user.editar')
                        @include('type_user.delete')
                    @endforeach
                </table>
                {{ $tus->links() }}
            @else
