            ...
            @if(isset($sections))
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" data-bs-toggle="modal" data-bs-target="#editarSection-{{$section->id}}"><i data-fa-symbol="edit" class="fa-solid fa-pencil fa-fw"></i></a>
                            <a href="" data-bs-toggle="modal" data-bs-target="#eliminarSection-{{$section->id}}"><i data-fa-symbol="delete" class="fa-solid fa-trash fa-fw" style="color:red"></i></a>
                        </td>
                    </tr>
                        @include('section.editar')
                        @include('section.delete')
                    @endforeach
                </table>
                {{ $sections->links() }}
            @else
